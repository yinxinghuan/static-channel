...
- 游戏：Static Channel
- 类型：casual
- 简述：An old CRT TV. Drag to tune 88–108 MHz — each frequency an AI channel: a weird VHS still + a one-line chyron, like mom rolling dumplings in 1994. Heart to keep a channel; open the wall.
...
- 平台元信息：meta.title=Static Channel；cover_url=/poster.png；category=casual；uuid=863f612f-b48e-407a-9b26-fd977321c758
...
- `src/StaticChannel/StaticChannel.tsx`
- `src/StaticChannel/StaticChannel.less`
- `src/StaticChannel/types.ts`
- `src/StaticChannel/index.ts`
- `src/StaticChannel/utils/audio.ts`
- `src/StaticChannel/utils/genImageWithRetry.ts`
- `src/StaticChannel/utils/bands.ts`
- `src/StaticChannel/utils/prompts.ts`
